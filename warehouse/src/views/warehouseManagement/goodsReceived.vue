    ...
    <mainLayout :routeName="routeName">
        ...
        <div class="content" v-else>
            ...
            <el-row>
                ...
                <el-button type="primary" icon="el-icon-delete" @click="deleteGoodsreceivednote()">删除</el-button>
                <el-button type="primary" icon="el-icon-s-check" @click="checkd()" v-if="$store.state.myUser.data.uAuthority<=2">审核</el-button>
                <el-button type="primary" icon="el-icon-sell" @click="inStock()" >入库</el-button>
                ...
                <el-dialog title="入库单" :visible.sync="addFormVisible">
                    <el-form :rules="rules" :model="goodsreceivednote" ref="goodsreceivednote" class="demo-ruleForm">
                        ...
                        <el-form-item label="入库类型" label-width="120px" prop="grnType" >
                            <el-select v-model="gType" placeholder="请选择入库类型" style="width: 100%" :disabled="checkFlag||goodsreceivednote.grnState>=2">

                                <el-option label="采购入库" value= 1></el-option>
                                <!--<el-option label="生产入库" value= 2></el-option>-->
                                <el-option label="退货入库" value= 3></el-option>
                                <!--<el-option label="调拨入库" value= 4></el-option>-->
                                <!--<el-option label="其他入库" value= 5></el-option>-->
                            </el-select>
                        </el-form-item>
                        <el-form-item label="所属仓库" label-width="120px" prop="warehouseId" style="text-align: left;" v-if="checkFlag==true||goodsreceivednote.grnType==3" >
                            <el-select v-model="grnWarehouse" placeholder="请选择所属仓库"  style="width: 100%" :disabled="goodsreceivednote.grnState>=2||goodsreceivednote.grnType==3&&checkFlag==true||showAllFlag==true">
                                <el-option
                        ...
                        <el-form-item label="所属库区" label-width="120px" prop="reservoirareaId" style="text-align: left" v-if="checkFlag==true" >
                            <el-select v-model="grnReservoirarea" placeholder="请选择所属库区"  style="width: 100%" :disabled="goodsreceivednote.grnState>=2||showAllFlag==true" >
                                <el-option
                        ...
                        <el-form-item label="货架" label-width="120px" prop="grnSrId" style="text-align: left" v-if="checkFlag==true" >
                            <el-select v-model="storageRackName" placeholder="请选择货架" style="width: 100%" :disabled="goodsreceivednote.grnState>=2||showAllFlag==true">
                                <el-option
                        ...
                        <el-form-item label="发货单" label-width="120px" prop="grnDpId" style="text-align: left" v-if="goodsreceivednote.grnType==3">
                            <el-select v-model="grnDpIds" placeholder="请选择被退回的发货单" style="width: 100%" :disabled="goodsreceivednote.grnState>=2||goodsreceivednote.grnType==3&&checkFlag==true||showAllFlag==true">
                                <el-option
                        ...
                        <!--<el-form-item label="订单编号" label-width="120px" :prop="goodsreceivednote.grnType==3 ? '' : 'grnOrderNum'">-->
                            <!--<el-input   v-model="goodsreceivednote.grnOrderNum" :disabled="goodsreceivednote.grnState>=2||checkFlag==true||goodsreceivednote.grnType==3" oninput="if (value.length>12) value= value.slice(0,12) "></el-input>-->
                        <!--</el-form-item>-->
                        <el-form-item label="入库物料" label-width="120px" :prop="goodsreceivednote.grnType==3 ? '' : 'grnMaterialId'" style="text-align: left;">
                            <el-select v-model="grnMaterials" placeholder="请选择物料" style="width: 100%" :disabled="goodsreceivednote.grnState>=2||checkFlag==true||goodsreceivednote.grnType==3||showAllFlag==true">
                                <el-option
                        ...
                        <el-form-item label="供应商" label-width="120px" prop="grnSplId" style="text-align: left" v-if="goodsreceivednote.grnType!=3">
                            <el-select v-model="splName" placeholder="请选择供应商" style="width: 100%" :disabled="goodsreceivednote.grnState>=2 ||checkFlag==true">
                                <el-option
                        ...
                        <el-form-item label="入库数量" label-width="120px" :prop="goodsreceivednote.grnType==3 ? '' : 'grnInQuantity'" >
                            <el-input   v-model="goodsreceivednote.grnInQuantity"
                                        ...
                                        :disabled="goodsreceivednote.grnState>=2 ||checkFlag==true||goodsreceivednote.grnType==3">
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="备注" label-width="120px" prop="grnComment">
                            <el-input type="textarea" placeholder="请输入备注"   v-model="goodsreceivednote.grnComment" oninput="if (value.length>100) value= value.slice(0,100) "
                                      :disabled="goodsreceivednote.grnState>=2"></el-input>
                        </el-form-item>
                    </el-form>
                    <div slot="footer" class="dialog-footer">

                        <el-button @click="addOrEdit ? exitAdd() : exitEdit()">取 消</el-button>
                        <el-button @click="quitCheck()" v-if="goodsreceivednote.grnState==2&&checkFlag==true">取消审核</el-button>
                        <el-button @click="addOrEdit ? submitForm('goodsreceivednote') : editGoodsreceivednote('goodsreceivednote')" v-if="goodsreceivednote.grnState<2&&showAllFlag==false" :disabled="showAllFlag==true" >确 定</el-button>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                routeName:{parentName:'仓库管理',name:'入库管理',needSlot:true},
                checkFlag:false,
                allOrselfFlag:true,
                dpReturnNote:null,
                showIdFlag:false,
        ...
        computed:{
            ...
            //         let note = await findReturnNote(4);
            //         if(note){
            //             return note
            //         }else{
            //             return null
        ...
        methods:{
            ...
            async checkStock(){  //检查货架是否能存储该次入库的物料,返回剩余能存储的数量
                let obj={}
                let mt = this.material.filter(value=>{
                    return this.goodsreceivednote.grnMaterialId == value.mtId
                })
                console.log(mt)
                let num;
                switch (mt[0].mtSize) {
                ...
                console.log(this.goodsreceivednote.grnSrId)
                let stck = await getStockBySrId(this.goodsreceivednote.grnSrId)
                console.log(stck)
                if(stck.code!=400){  //如果库存表已经存在了该货架的数据了，则库存就在该基础上加上入库物料即可
            ...
            async addStock(){   //把审核完成的单据提取必要的信息存进stock表
                let flag = false
                let obj = await this.checkStock()
                console.log(obj)
                let stock = {}
                if(obj.empty==true){  //根据stock表内是否存在了该货架的物料，如果不存在的或就把各种信息存好在stock对象内

                    let nm =obj.num-this.goodsreceivednote.grnInQuantity
                    console.log(nm)
                    if(nm>=0) {
                        stock.mtId = this.goodsreceivednote.grnMaterialId
                        stock.mtName = this.goodsreceivednote.grnMaterialName
                        stock.whId = this.warehouseId
                        stock.whName = this.grnWarehouse
                        stock.raId = this.goodsreceivednote.reservoirareaId
                        stock.raName = this.grnReservoirarea
                        stock.srId = this.goodsreceivednote.grnSrId
                        stock.srName = this.goodsreceivednote.grnSrName
                        stock.currentStock = this.goodsreceivednote.grnInQuantity
                        stock.safeStock = obj.num
                        stock.creationTime = this.goodsreceivednote.grnModificationTime
                        stock.modificationTime = this.goodsreceivednote.grnModificationTime
                        console.log(stock)
                        let resp;

                        resp = await updateStockAndStoragerack(3, this.goodsreceivednote.grnId,this.goodsreceivednote.grnDpId,stock)
                        console.log(resp)
                        if (resp.code == 200) {
                            flag = true
                        }else{
                        ...
                        this.$message.error('入库量过多，请分批申请！该货架当前剩余库存量为：'+ obj.num);
                    }
                    ...
                    if(nm>=0){
                        stock.mtId = this.goodsreceivednote.grnMaterialId
                        stock.srId = this.goodsreceivednote.grnSrId
                        stock.currentStock = parseInt(this.goodsreceivednote.grnInQuantity)+parseInt(obj.nowNum)
                        stock.modificationTime = this.goodsreceivednote.grnModificationTime
                        console.log(stock)
                        console.log(this.goodsreceivednote.grnDpId)
                        let resp = await updateStock(3,this.goodsreceivednote.grnId,this.goodsreceivednote.grnDpId,stock)
                        console.log(resp)
                        if(resp.code==200){
                            flag = true
                        }else{
            ...
            async showAddForm(){  //点击添加按钮时触发
                ...
                this.goodsreceivednote = this.deepClone(this.tempGoodsreceivednote);//把carrier的内容初始化
                this.addFormVisible=true;  //显示表单
                this.warehouseId = null;
                this.checkFlag = false
                this.showAllFlag = false
                this.addOrEdit=true;  //显示添加表单
                this.goodsreceivednote.grnId= this.getTime().id;
            ...
            async quitCheck(){  //取消审核
                if(this.$refs.tb.selection.length!=0){
                    this.goodsreceivednote = this.deepClone(this.$refs.tb.selection[0]);
                    if(this.goodsreceivednote.grnModifierId == this.$store.state.myUser.data.uId){
                        this.goodsreceivednote.grnState = 1;
                        this.goodsreceivednote.grnModificationTime = null;
                        this.goodsreceivednote.grnModifierId = null;
                        if(this.goodsreceivednote.grnType!=3){
                            this.goodsreceivednote.warehouseId = null;
                            this.goodsreceivednote.warehouseName = null;
                        }

                        this.goodsreceivednote.reservoirareaId = null;
                        this.goodsreceivednote.reservoirareaName = null;
                        this.goodsreceivednote.grnSrId = null;
                        this.goodsreceivednote.grnSrName = null;
                        let resp = await editGoodsReceivedNote(this.goodsreceivednote,null,null);
                        if(resp.code == 200){
                            this.$alert('取消成功', '提示', {
            ...
            async inStock(){
              if(this.$refs.tb.selection.length != 0){
                  this.$confirm('是否入库?', '提示', {
                      ...
                      this.goodsreceivednote = this.deepClone(this.$refs.tb.selection[0]);
                      if(this.goodsreceivednote.grnState==2){
                          let resp = await this.addStock();
                          if(resp){
                              this.$message({
                                  type: 'success',
                                  message: '入库成功!'
                          ...
                          this.$message.error('入库失败，只能入库处于待入库状态的单据！');
                      }
                  }).catch(() => {
                      this.$message({
                          type: 'info',
            ...
            editGoodsreceivednote(formName){  //修改表单的确定按钮触发
                ...
                this.$refs[formName].validate( async (valid) => {
                    if (valid) {
                        ...
                        if(this.checkFlag){  //代表着这个修改表单是用于审核的
                            this.goodsreceivednote.grnModificationTime = time;
                            this.goodsreceivednote.grnModifierId = this.$store.state.myUser.data.uId;
                                this.goodsreceivednote.grnState = 2;
                            let obj = await this.checkStock();

                                resp = await editGoodsReceivedNote(this.goodsreceivednote,null,null);
                            ...
                            if(this.tempDpId&&this.goodsreceivednote.grnType!=3){
                                resp = await editGoodsReceivedNote(this.goodsreceivednote,this.tempDpId,4);
                            }else if(this.goodsreceivednote.grnType==3){
                                resp = await editGoodsReceivedNote(this.goodsreceivednote,this.goodsreceivednote.grnDpId,5);
                            }else{
                                resp = await editGoodsReceivedNote(this.goodsreceivednote,null,null);
                            }
                            console.log(resp)
            ...
            submitForm(formName){  //添加表单的触发事件
                let time = this.getTime().time;
                this.grnState = 1;
                this.goodsreceivednote.grnCreationTime = time;
                this.goodsreceivednote.grnCreatorId = this.$store.state.myUser.data.uId
                this.$refs[formName].validate( async (valid) => {
                    if (valid) {
                         console.log(this.goodsreceivednote)
                        let resp = await addGoodsReceivedNote(this.goodsreceivednote,this.goodsreceivednote.grnDpId)
                         console.log(resp)
                        if(resp.code == 200){
                            this.$alert('添加成功', '提示', {
                                confirmButtonText: '确定',
            ...
            deleteGoodsreceivednote(){  //删除按钮触发
                if (this.$refs.tb.selection.length != 0){
                    this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                        ...
                        this.goodsreceivednote = this.$refs.tb.selection[0];
                        if(this.goodsreceivednote.grnState==2){
                            this.$message.error('不能删除已经审核过的单据，请先取消审核再删除');
                        }else if(this.goodsreceivednote.grnState==3){
                            this.$message.error('已经入库的单据不能删除！');
                        }else{
                            let result = await deleteGoodsReceivedNote(this.$refs.tb.selection[0].grnId,this.$refs.tb.selection[0].grnDpId)
                            this.getList();
                            this.$message({
                                type: 'success',
                                message: '删除成功!'
